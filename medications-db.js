...
const MEDICATIONS_DB = [
  ...
  // אמיקצין ומרופנם בשאיפה: לשתיהן אין תכשיר אינהלציה רשום בשום מקום בעולם —
  // בפועל מנפצים את הבקבוקון של הצורה הוורידית. לכן מה שמופיע כאן הוא המינונים
  // שמתועדים בספרות לשאיפה, שגם תואמים לעוצמות הבקבוקונים בפועל:
  // אמיקצין — 250 מ"ג (מתחת ל-50 ק"ג) או 500 מ"ג, מנבולייזר mesh (frontiersin.org)
  // מרופנם — 250 מ"ג פעמיים ביום בברונכיאקטזיות (ERS 2023); 500 מ"ג הוא הבקבוקון התקני
  // השמות כוללים "(אינהלציה)" במפורש כדי שלא יתבלבלו עם אותה תרופה במתן ורידי,
  // באותו אופן שבו "טובי (תמיסה לאינהלציה)" מובחנת מ"טובי פודהלר" למעלה
  { he: 'אמיקצין (אינהלציה)', en: 'Amikacin (inhaled)', aliases: ['אמיקין (אינהלציה)', 'אמיקסין (אינהלציה)'], doses: ['250 מ״ג', '500 מ״ג'] },
  { he: 'מרופנם (אינהלציה)', en: 'Meropenem (inhaled)', aliases: ['מרונם (אינהלציה)'], doses: ['250 מ״ג', '500 מ״ג'] },
